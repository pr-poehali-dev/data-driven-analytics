      ...
      <div className="mx-auto w-full max-w-7xl text-center">
        ...
        >
          <button
            ...
            className="group relative inline-flex items-center justify-center border border-foreground/30 bg-foreground/10 px-12 py-5 backdrop-blur-md transition-all duration-300 hover:bg-foreground/20 hover:border-foreground/60 hover:scale-105"
          >
